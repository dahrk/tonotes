...
const electronAPI = {
  // Note operations
  createNote: (request: CreateNoteRequest) => ipcRenderer.invoke('create-note', request),
  updateNote: (request: UpdateNoteRequest) => ipcRenderer.invoke('update-note', request),
